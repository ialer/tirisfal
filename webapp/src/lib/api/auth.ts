...
const SESSION_KEY = 'tirisfal.web.session.v4';
const PROFILE_SNAPSHOT_KEY = 'tirisfal.web.profile-snapshot.v1';
const DEVICE_IDENTIFIER_KEY = 'tirisfal.web.device.identifier.v1';
const TOTP_REMEMBER_TOKEN_KEY = 'tirisfal.web.totp.remember-token.v1';
const WEB_SESSION_HEADER = 'X-Tirisfal-Web-Session';
