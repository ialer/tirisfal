...
export const DEMO_CIPHERS: Cipher[] = [
  {
    ...
    login: {
      username: 'demo@tirisfal.app',
      password: 'correct-horse-battery-staple',
      totp: 'otpauth://totp/GitHub:demo%40tirisfal.app?secret=JBSWY3DPEHPK3PXP&issuer=GitHub',
      decUsername: 'demo@tirisfal.app',
      decPassword: 'correct-horse-battery-staple',
      decTotp: 'otpauth://totp/GitHub:demo%40tirisfal.app?secret=JBSWY3DPEHPK3PXP&issuer=GitHub',
    ...
    fields: [
      { type: 0, name: 'Recovery email', value: 'ops@tirisfal.app', decName: 'Recovery email', decValue: 'ops@tirisfal.app' },
  ...
  },
  {
    ...
    login: {
      username: 'admin@tirisfal.app',
      password: 'demo-cloudflare-password',
      totp: 'otpauth://totp/Cloudflare:admin%40tirisfal.app?secret=JBSWY3DPEHPK3PXP&issuer=Cloudflare',
      decUsername: 'admin@tirisfal.app',
      decPassword: 'demo-cloudflare-password',
      decTotp: 'otpauth://totp/Cloudflare:admin%40tirisfal.app?secret=JBSWY3DPEHPK3PXP&issuer=Cloudflare',
  ...
  },
  {
    ...
    login: {
      username: 'workspace.admin@tirisfal.app',
      password: 'demo-google-password-2026',
      totp: 'otpauth://totp/Google:workspace.admin%40tirisfal.app?secret=JBSWY3DPEHPK3PXP&issuer=Google',
      decUsername: 'workspace.admin@tirisfal.app',
      decPassword: 'demo-google-password-2026',
      decTotp: 'otpauth://totp/Google:workspace.admin%40tirisfal.app?secret=JBSWY3DPEHPK3PXP&issuer=Google',
    ...
    fields: [
      { type: 0, name: 'Recovery email', value: 'recovery@tirisfal.app', decName: 'Recovery email', decValue: 'recovery@tirisfal.app' },
  ...
  },
  {
    ...
    login: {
      username: 'admin@tirisfal.onmicrosoft.com',
      password: 'demo-microsoft-password-2026',
      totp: 'otpauth://totp/Microsoft:admin%40tirisfal.onmicrosoft.com?secret=JBSWY3DPEHPK3PXP&issuer=Microsoft',
      decUsername: 'admin@tirisfal.onmicrosoft.com',
      decPassword: 'demo-microsoft-password-2026',
      decTotp: 'otpauth://totp/Microsoft:admin%40tirisfal.onmicrosoft.com?secret=JBSWY3DPEHPK3PXP&issuer=Microsoft',
  ...
  },
  {
    ...
    login: {
      ...
      totp: 'otpauth://totp/Amazon:demo%40tirisfal.app?secret=JBSWY3DPEHPK3PXP&issuer=Amazon',
      decUsername: 'demo@tirisfal.app',
      decPassword: 'demo-amazon-password-2026',
      decTotp: 'otpauth://totp/Amazon:demo%40tirisfal.app?secret=JBSWY3DPEHPK3PXP&issuer=Amazon',
  ...
  },
  {
    ...
    login: {
      username: 'family@tirisfal.app',
      password: 'demo-netflix-password-2026',
      totp: 'otpauth://totp/Netflix:family%40tirisfal.app?secret=JBSWY3DPEHPK3PXP&issuer=Netflix',
      decUsername: 'family@tirisfal.app',
      decPassword: 'demo-netflix-password-2026',
      decTotp: 'otpauth://totp/Netflix:family%40tirisfal.app?secret=JBSWY3DPEHPK3PXP&issuer=Netflix',
  ...
  },
  {
    ...
    login: {
      username: 'billing@tirisfal.app',
      password: 'demo-paypal-password-2026',
      totp: 'otpauth://totp/PayPal:billing%40tirisfal.app?secret=JBSWY3DPEHPK3PXP&issuer=PayPal',
      decUsername: 'billing@tirisfal.app',
      decPassword: 'demo-paypal-password-2026',
      decTotp: 'otpauth://totp/PayPal:billing%40tirisfal.app?secret=JBSWY3DPEHPK3PXP&issuer=PayPal',
  ...
  },
  {
    ...
    card: {
      cardholderName: 'Tirisfal Demo',
      number: '4111 1111 1111 1111',
      brand: 'Visa',
      expMonth: '12',
      expYear: '2030',
      code: '123',
      decCardholderName: 'Tirisfal Demo',
  ...
  },
  {
    ...
    sshKey: {
      ...
      publicKey: 'ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIDemoTirisfalKey demo@tirisfal',
      keyFingerprint: 'SHA256:demoTirisfalFingerprint',
      decPrivateKey: '-----BEGIN OPENSSH PRIVATE KEY-----\nDEMO-PRIVATE-KEY\n-----END OPENSSH PRIVATE KEY-----',
      decPublicKey: 'ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIDemoTirisfalKey demo@tirisfal',
      decFingerprint: 'SHA256:demoTirisfalFingerprint',
    },
  },
  {
    id: 'cipher-archived',
...
export const DEMO_SENDS: Send[] = [
  {
    ...
    text: { text: 'Welcome to Tirisfal demo mode.', hidden: false },
    decText: 'Welcome to Tirisfal demo mode.',
    accessCount: 3,
    maxAccessCount: 10,
    disabled: false,
...
export function getDemoPublicSend(accessId: string): {
  ...
  if (normalized === 'demo-note') {
    return {
      ...
      type: 0,
      decName: 'Onboarding note',
      decText: 'Welcome to Tirisfal demo mode. This public Send page is served entirely from demo data.',
  ...
  destinations: [
    {
      ...
      destination: {
        baseUrl: 'https://dav.example.com/tirisfal',
      ...
      runtime: {
        ...
        lastUploadedFileName: 'tirisfal_backup_20260504_030112_a1b2c.zip',
...
function createDemoRemoteBrowser(destinationId: string, path: string = ''): RemoteBackupBrowserResponse {
  return {
    ...
    items: [
      {
        path: 'tirisfal_backup_20260504_030112_a1b2c.zip',
        name: 'tirisfal_backup_20260504_030112_a1b2c.zip',
        isDirectory: false,
        size: 1048576,
...
function createDemoBackupRun(settings: AdminBackupSettings, destinationId: string | null | undefined): AdminBackupRunResponse {
  ...
  return {
    object: 'backup-run',
    result: {
      fileName: 'tirisfal_backup_20260504_030112_a1b2c.zip',
      fileSize: 1048576,
      provider: destination.type,
      remotePath: 'tirisfal/tirisfal_backup_20260504_030112_a1b2c.zip',
    },
    settings,
  };
}
...
export function createDemoMainRoutesProps(base: AppMainRoutesProps, notify: Notify, state: DemoRouteState): AppMainRoutesProps {
  ...
  return {
    ...
    onInspectRemoteBackup: async (_destinationId: string, path: string) => ({
      ...
      path,
      fileName: path.split('/').pop() || 'tirisfal_backup_demo.zip',
      integrity: {
    ...
    onRestoreRemoteBackup: async (_destinationId, path) => {
      await runDemoRemoteRestoreProgress(path.split('/').pop() || path || 'tirisfal_backup_demo.zip');
      resetDemoVaultState(state);
