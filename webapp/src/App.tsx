...
const THEME_STORAGE_KEY = 'tirisfal.theme.preference.v1';
...
const LOCK_TIMEOUT_STORAGE_KEY = 'tirisfal.lock.timeout-minutes.v1';
const SESSION_TIMEOUT_ACTION_STORAGE_KEY = 'tirisfal.session.timeout-action.v1';
...
export default function App() {
  ...
  const importAuthedFetch = useMemo(
    () => async (input: string, init?: RequestInit) => {
      ...
      headers.set('X-Tirisfal-Import', '1');
  ...
  const demoDomainRules = useMemo<DomainRules>(() => ({
    equivalentDomains: [
      ['tirisfal.example', 'nw.example'],
      ['staging.tirisfal.example', 'preview.tirisfal.example'],
    ],
    customEquivalentDomains: [
      { id: 'demo-custom-1', domains: ['tirisfal.example', 'nw.example'], excluded: false },
      { id: 'demo-custom-2', domains: ['staging.tirisfal.example', 'preview.tirisfal.example'], excluded: false },
    ],
    globalEquivalentDomains: [
      ...
      { type: -10001, domains: ['tirisfal.example', 'nw.example'], excluded: false },
    ],
    object: 'domains',
  }), []);
