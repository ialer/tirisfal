...
const NAV_LAYOUT_STORAGE_KEY = 'tirisfal.navLayoutMode';
    ...
    <div className="app-page">
      <div className="app-shell">
        <header className="topbar">
          <div className="brand">
            <img src="/tirisfal-logo.svg" alt="Tirisfal logo" className="brand-logo" />
            <span className="brand-wordmark" role="img" aria-label="Tirisfal" />
